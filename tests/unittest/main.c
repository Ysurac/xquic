...
main(int argc, char *argv[])
{
    ...
    if (!CU_add_test(pSuite, "xqc_cid_test", xqc_test_cid)
        ...
        || !CU_add_test(pSuite, "xqc_test_wlb_evicted_probe_never_carries_unique_stream_data", xqc_test_wlb_evicted_probe_never_carries_unique_stream_data)
        ...
        || !CU_add_test(pSuite, "xqc_test_wlb_equal_goodput_is_balanced", xqc_test_wlb_equal_goodput_is_balanced)
        || !CU_add_test(pSuite, "xqc_test_wlb_bloated_path_sheds_weight", xqc_test_wlb_bloated_path_sheds_weight)
        || !CU_add_test(pSuite, "xqc_test_wlb_four_to_one_goodput_after_acked_warmup", xqc_test_wlb_four_to_one_goodput_after_acked_warmup)
        || !CU_add_test(pSuite, "xqc_test_wlb_new_path_gets_warmup_floor", xqc_test_wlb_new_path_gets_warmup_floor)
        || !CU_add_test(pSuite, "xqc_test_wlb_steady_path_gets_exploration_floor", xqc_test_wlb_steady_path_gets_exploration_floor)
        || !CU_add_test(pSuite, "xqc_test_wlb_active_time_ends_warmup", xqc_test_wlb_active_time_ends_warmup)
        || !CU_add_test(pSuite, "xqc_test_wlb_idle_time_does_not_end_warmup", xqc_test_wlb_idle_time_does_not_end_warmup)
        || !CU_add_test(pSuite, "xqc_test_wlb_latency_policy_uses_minrtt", xqc_test_wlb_latency_policy_uses_minrtt)
        || !CU_add_test(pSuite, "xqc_test_wlb_path_stats_snapshot", xqc_test_wlb_path_stats_snapshot)
        || !CU_add_test(pSuite, "xqc_test_wlb_pinned_flow_refreshes_delivery_sample", xqc_test_wlb_pinned_flow_refreshes_delivery_sample)
        || !CU_add_test(pSuite, "xqc_test_wlb_warmup_time_only_credits_selected_path", xqc_test_wlb_warmup_time_only_credits_selected_path)
        || !CU_add_test(pSuite, "xqc_test_wlb_throughput_policy_resets_delivery_learning", xqc_test_wlb_throughput_policy_resets_delivery_learning)
        || !CU_add_test(pSuite, "xqc_test_wlb_topology_refresh_clears_packet_deficit", xqc_test_wlb_topology_refresh_clears_packet_deficit)
        || !CU_add_test(pSuite, "xqc_test_wlb_topology_refresh_clears_pin_deficit", xqc_test_wlb_topology_refresh_clears_pin_deficit)
        || !CU_add_test(pSuite, "xqc_test_wlb_late_flow_alternates_after_round_boundary", xqc_test_wlb_late_flow_alternates_after_round_boundary)
        || !CU_add_test(pSuite, "xqc_test_wlb_ewma_uses_exact_seven_eighths_history", xqc_test_wlb_ewma_uses_exact_seven_eighths_history)
        || !CU_add_test(pSuite, "xqc_test_wlb_loss_above_two_percent_downweights_path", xqc_test_wlb_loss_above_two_percent_downweights_path)
        || !CU_add_test(pSuite, "xqc_test_wlb_public_scid_policy_and_truncated_stats", xqc_test_wlb_public_scid_policy_and_truncated_stats)
        || !CU_add_test(pSuite, "xqc_test_wlb_control_delivery_does_not_advance_learning", xqc_test_wlb_control_delivery_does_not_advance_learning)
        || !CU_add_test(pSuite, "xqc_test_wlb_application_delivery_advances_learning", xqc_test_wlb_application_delivery_advances_learning)
        || !CU_add_test(pSuite, "xqc_test_wlb_latency_policy_populates_stats_before_payload", xqc_test_wlb_latency_policy_populates_stats_before_payload)
        || !CU_add_test(pSuite, "xqc_test_wlb_latency_policy_syncs_path_add_remove", xqc_test_wlb_latency_policy_syncs_path_add_remove)
        || !CU_add_test(pSuite, "xqc_test_wlb_duplicate_ack_counts_application_once", xqc_test_wlb_duplicate_ack_counts_application_once)
        || !CU_add_test(pSuite, "xqc_test_fc_stream_window_cap_pins_autotune", xqc_test_fc_stream_window_cap_pins_autotune)
        || !CU_add_test(pSuite, "xqc_test_fc_conn_window_cap_pins_autotune", xqc_test_fc_conn_window_cap_pins_autotune)
        || !CU_add_test(pSuite, "xqc_test_fc_rate_limit_ignores_init_max_data", xqc_test_fc_rate_limit_ignores_init_max_data)
        || !CU_add_test(pSuite, "xqc_test_fc_recv_window_cap_direction_mapping", xqc_test_fc_recv_window_cap_direction_mapping)
        /* ADD TESTS HERE */)
    {
        CU_cleanup_registry();
        return (int)CU_get_error();
